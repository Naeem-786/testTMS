                ...
                <div class="table-responsive" id="raw_category">                   
                    ...
                    <table id="myTable" class="table  datanew">
                        <thead>
                            ...
                            ?>
                            <h2 class="text-center h2_heading"><?php echo $total_stitching_orders?>:Order in Stitching Unit</h2>
                            <tr>
                                <th>Sr.No.</th>
                                <th>Order Dated</th>
                                <th>Suit No.</th>
                        ...
                        <tbody>
                            <?php                               
                                $query = "SELECT * FROM addneworder WHERE progress_suit IN ('stitching_unit') ORDER BY delivery_date ASC";                              
